...
class WebShoeView extends StatefulWidget {
  final ShoeModel shoe;
  final String tag;
  const WebShoeView({super.key, required this.shoe, required this.tag});

  @override
  State<WebShoeView> createState() => _WebShoeViewState();
}

class _WebShoeViewState extends State<WebShoeView> {
  bool isLiked = false;
